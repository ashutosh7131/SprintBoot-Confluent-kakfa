# GDI.ES.Loyalty.Consumer.Sales

Project for consumer for Sales Trickle Topic
...
```
cd existing_repo
git remote add origin https://git.homeoffice.anfcorp.com/integration-modernization/gdi.es.loyalty.consumer.sales.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.homeoffice.anfcorp.com/integration-modernization/gdi.es.loyalty.consumer.sales/-/settings/integrations)
...
Use examples liberally, and show the expected output if you can. It's helpful to have inline the smallest salesTopicMessage of
